...
# Write dogsInfo to JSON file
json_string = json.dumps(dogsInfo)
with open("dogsInfo.json", "w") as outfile:
    outfile.write(json_string)

#### Already Has JSON Data File

# Read dogsInfo JSON file to dict
with open('dogsInfo.json') as json_file:
...
def chooseOneDog(tree):
    ...
    print("The other information about this dog are as below: ", tree.val[q].weight, tree.val[q].height, tree.val[q].size, tree.val[q].lifeSpan, tree.val[q].origin)
